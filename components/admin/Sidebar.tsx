	...
	return (
		<aside
			className={clsx(
				...
				"pt-24 pb-6 transition-all duration-300"
			)}
		>
			<div className="flex-1 flex flex-col px-4">
				...
				<div className="pt-4 mt-4 border-t border-neutral-200">
					<button
						...
						className="group w-full flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-neutral-700 hover:bg-red-50 hover:text-red-700 active:bg-red-100 transition-all duration-200"
					>
